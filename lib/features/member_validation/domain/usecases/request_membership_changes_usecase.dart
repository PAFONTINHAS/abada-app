...
class RequestMembershipChangesUseCase {
  ...
  RequestMembershipChangesUseCase(this.repository);
  //constructor da classe, recebe as variaveis definidas

  Future<Either<Failure, void>> call(String requestId, String changeReason) async {
